...
BACKEND_VALIDATION_URL = "http://localhost:8080/api/v1/ai/painting-id"
BACKEND_RESPONSE_URL = "http://localhost:8080/api/v1/ai/object-description"  
ACCESS_TOKEN = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1c2VyMSIsImlhdCI6MTc0ODc3Mzk2NCwiZXhwIjoxNzQ4Nzc3NTY0fQ.7b78D6DdUXAs6LIwO-vnSSa87B743nfP1Cnx45H42ac"  # 실제 토큰으로 대체
